...
RegisterNetEvent('mVeinPaycheck:server:AddMoneyToPayCheck', function(citizenid, amount, from)
     addmoney_to_paycheck(citizenid, amount, from)
end)

QBCore.Functions.CreateCallback('mVeinPaycheck:server:account_information', function(source, cb)
...
QBCore.Functions.CreateCallback('mVeinPaycheck:server:withdraw_all', function(source, cb)
     local Player = QBCore.Functions.GetPlayer(source)
     local citizenid = Player.PlayerData.citizenid
...
QBCore.Functions.CreateCallback('mVeinPaycheck:server:withdraw_amount', function(source, cb, amount)
     local Player = QBCore.Functions.GetPlayer(source)
     local citizenid = Player.PlayerData.citizenid
...
QBCore.Functions.CreateCallback('mVeinPaycheck:server:get_logs', function(source, cb, limit)
